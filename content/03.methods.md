...
We used the scikit-learn software package [@url:http://jmlr.csail.mit.edu/papers/v12/pedregosa11a.html] in Python to train a traditional multivariable logistic regression model, a penalized regression model (L1 and L2 penalties), and an XGBoost classification model [@url:https://hal.archives-ouvertes.fr/hal-00650905/].
